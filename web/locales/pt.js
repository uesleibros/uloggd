export default {
	acknowledgements: {
	  ...
	  description: "O uloggd é construído sobre incríveis projetos open source e serviços. Somos gratos a todos eles.",
	  backToHome: "Voltar ao início",
	  empty: "Nenhum reconhecimento nesta categoria.",
	  missing: "Acha que esquecemos algo?",
	  letUsKnow: "Nos avise",
	  categories: {
	    all: "Todos",
	...
	auth: {
		...
		passkeyError: {
			generic: "Falha ao autenticar com passkey.",
		...
		page: {
			...
			signInDescription: "Escolha uma opção para entrar",
			or: "ou",
			signInButton: "Entrar",
		}
	},
	...
	settings: {
		...
		nintendo: {
		  ...
		  connected: "Conectado",
		  remove: "Desconectar",
		  description: "Vincule sua conta do Nintendo Switch para exibir seu perfil e código de amigo.",
		  connect: "Conectar Nintendo",
		  modal: {
		    title: "Conectar Nintendo Switch",
		    subtitle: "Verifique a posse da sua conta",
		    betaTitle: "Disponibilidade Limitada",
		    betaDesc: "Essa funcionalidade está disponível para um número limitado de usuários. Se sua conta não for encontrada, pode ser que ainda não esteja disponível pra você.",
		    step1Title: "Insira seu Código de Amigo",
		    step1Desc: "Você encontra seu código de amigo nas configurações de perfil do Nintendo Switch.",
		    step2Title: "Essa é sua conta?",
		    step2Desc: "Encontramos essa conta Nintendo. Confirme que ela pertence a você.",
		    step3Title: "Verificar propriedade",
		    step3Desc: "Para provar que essa conta é sua, altere temporariamente o apelido do seu Nintendo Switch para o código abaixo.",
		    changeNameTo: "Altere seu apelido para:",
		    changeNameHint: "Você pode voltar ao nome original após a verificação.",
		    howToChangeName: "Como alterar seu apelido:",
		    step3_1: "Vá para a tela inicial do Switch",
		    step3_2: "Selecione o ícone do seu perfil (canto superior esquerdo)",
		    step3_3: "Selecione \"Perfil\" e depois \"Apelido\"",
		    step3_4: "Altere para {{code}} e salve",
		    successTitle: "Conta conectada!",
		    successDesc: "Sua conta Nintendo Switch foi vinculada com sucesso.",
		    restoreNameHint: "Agora você pode voltar seu apelido do Nintendo Switch para o nome original.",
		    nxapiCredit: "Essa funcionalidade é possível graças ao nxapi, uma biblioteca não oficial da API do Nintendo Switch. Não somos afiliados à Nintendo.",
		    cancel: "Cancelar",
		    search: "Buscar",
		    searching: "Buscando...",
		    yesItsMe: "Sim, sou eu",
		    ...
		    errorRateLimit: "Muitas tentativas. Aguarde antes de tentar novamente.",
		    errorAlreadyLinked: "Esse código de amigo já está vinculado a outra conta.",
		    errorNotFound: "Nenhuma conta encontrada com esse código de amigo. Essa funcionalidade pode não estar disponível para sua conta ainda.",
		    errorGeneric: "Algo deu errado. Tente novamente.",
		    errorMaxAttempts: "Número máximo de tentativas atingido. Comece novamente.",
		    errorCooldown: "Aguarde antes de tentar novamente.",
		    errorNameMismatch: "Seu apelido ainda não corresponde ao código de verificação. Verifique se salvou a alteração no Switch.",
		    errorVerifyFailed: "Verificação falhou. Tente novamente.",
		    attemptsLeft: "{{count}} tentativa(s) restante(s)",
		    cooldown: "Aguarde {{seconds}}s antes da próxima tentativa",
		    retryIn: "Tente novamente em {{seconds}}s",
		  },
		},
	},
	imageCrop: {
