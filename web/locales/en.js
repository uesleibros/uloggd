export default {
	...
	home: {
		...
		sections: {
			...
			popularTierlists: "Popular Tier Lists"
		},
	},
	notFound: {
		title: "404",
	...
	auth: {
		...
		passkeyError: {
			generic: "Failed to authenticate with passkey.",
		...
		page: {
			...
			signInDescription: "Choose an option to sign in",
			or: "or",
	...
	settings: {
		...
		nintendo: {
		  ...
		  connected: "Connected",
		  remove: "Disconnect",
		  description: "Link your Nintendo Switch account to display your profile and friend code.",
		  connect: "Connect Nintendo",
		  modal: {
		    title: "Connect Nintendo Switch",
		    subtitle: "Verify your account ownership",
		    betaTitle: "Limited Availability",
		    betaDesc: "This feature is currently available to a limited number of users. If your account can't be found, it may not be available for you yet.",
		    step1Title: "Enter your Friend Code",
		    step1Desc: "You can find your friend code in your Nintendo Switch profile settings.",
		    step2Title: "Is this your account?",
		    step2Desc: "We found this Nintendo account. Please confirm it belongs to you.",
		    step3Title: "Verify ownership",
		    step3Desc: "To prove this is your account, temporarily change your Nintendo Switch nickname to the code below.",
		    changeNameTo: "Change your nickname to:",
		    changeNameHint: "You can change it back after verification.",
		    howToChangeName: "How to change your nickname:",
		    step3_1: "Go to your Switch home screen",
		    step3_2: "Select your profile icon (top left)",
		    step3_3: "Select \"Profile\" and then \"Nickname\"",
		    step3_4: "Change it to {{code}} and save",
		    successTitle: "Account connected!",
		    successDesc: "Your Nintendo Switch account has been successfully linked.",
		    restoreNameHint: "You can now change your Nintendo Switch nickname back to your original name.",
		    nxapiCredit: "This feature is powered by nxapi, an unofficial Nintendo Switch API library. We are not affiliated with Nintendo.",
		    cancel: "Cancel",
		    search: "Search",
		    searching: "Searching...",
		    ...
		    errorAlreadyLinked: "This friend code is already linked to another account.",
		    errorNotFound: "No account found with this friend code. This feature may not be available for your account yet.",
		    errorGeneric: "Something went wrong. Please try again.",
		    errorMaxAttempts: "Maximum verification attempts reached. Please start over.",
		    errorCooldown: "Please wait before trying again.",
		    errorNameMismatch: "Your nickname doesn't match the verification code yet. Make sure you saved the change on your Switch.",
		    errorVerifyFailed: "Verification failed. Please try again.",
		    attemptsLeft: "{{count}} attempt(s) remaining",
		    cooldown: "Wait {{seconds}}s before next attempt",
