    ...
    <div className="p-4 space-y-4">
      <div>
        <textarea
          ...
          placeholder={t("thinking.placeholder")}
          rows={3}
      ...
      {text ? (
        <div style={{ animation: 'tbFloat 4s ease-in-out infinite' }}>
          <div className="group flex flex-col items-center md:items-start">
            <div
              className="relative bg-zinc-800/95 backdrop-blur-sm border border-zinc-600/80 rounded-[20px] px-3.5 py-2 w-max max-w-[280px]"
            ...
            >
              ...
              {isOwnProfile && (
                ...
                >
                  <Pencil className="w-3 h-3 text-zinc-200" />
                </button>
              )}
            </div>
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-2 whitespace-nowrap">
              ...
              <span className="text-xs text-zinc-500 group-hover:text-zinc-300 font-medium transition-colors">{t("thinking.addThought")}</span>
            </div>
          </button>
          <div className="pl-3 mt-1 space-y-[3px]">
