...
export default function SteamSection() {
  ...
  if (loading) {
    return (
      <SettingsSection title={t("settings.steam.title")}>
            ...
            {isConnected ? (
              <>
                ...
                <div className="text-xs text-zinc-500 mb-3">
                  {t("settings.steam.idLabel")} {connection.steamId}
                </div>
