        ...
        if (item.provider === "psn") {
          return (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-[#003791]/20 border border-[#003791]/50 text-[#0070cc] text-xs transition-all duration-200 hover:bg-[#003791]/30"
            >
              <Icon className="w-3.5 h-3.5" />
              <span className="truncate">{item.display}</span>
              <ExternalLink className="w-2.5 h-2.5 opacity-50 group-hover:opacity-80 transition-opacity" />
