  ...
  return (
    <>
      <div className="flex items-center gap-3 sm:gap-5 mt-3 flex-wrap">
        <SocialCount value={followersCount} label={t("stats.followers")} onClick={onFollowersClick} />
        <SocialCount value={followingCount} label={t("stats.following")} onClick={onFollowingClick} />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
        <StatCard value={counts.playing} label={t("stats.playing")} />
        <StatCard value={counts.played} label={t("stats.played")} />
        <StatCard value={counts.backlog} label={t("stats.backlog")} />
        <StatCard value={counts.rated} label={t("stats.rated")} />
      </div>
