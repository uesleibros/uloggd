...
const ACKNOWLEDGEMENTS = [
  ...
  {
    name: "NXAPI",
    description: "Unofficial Nintendo Switch Online API client enabling Nintendo account integrations.",
    category: "data",
    url: "https://github.com/samuelthomas2774/nxapi",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Nintendo_Switch_Logo.svg/120px-Nintendo_Switch_Logo.svg.png",
    color: "#e60012",
  },
  {
    name: "Decors",
    description: "Avatar decoration service providing profile customization assets.",
    category: "tools",
    url: "https://decor.firecord.de",
    logo: "https://decor.firecord.de/favicon.ico",
    color: "#f47fff",
  },
  {
    name: "React",
  ...
  {
    name: "React Router",
    description: "Declarative routing library handling all navigation and URL management across the app.",
    category: "libraries",
