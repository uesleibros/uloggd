...
- Share is a quiet hero utility in the artwork's upper-right corner, clear of the title and gameplay actions. It retains the shared 38px/40px contract and moves below the floating header on mobile.
