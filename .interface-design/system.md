...
- A review can link to one of the game's journeys through a "Jornada" Radix select in the Details tab ("Nenhuma" clears it). The journey title then renders as a Map chip on activity rows and as a link chip on the review page pointing to the game's logs timeline.
