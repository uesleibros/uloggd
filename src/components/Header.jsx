...
function AuthButtons({ onNavigate, variant = "desktop" }) {
    ...
    return (
      <div className="pt-2 border-t border-zinc-800">
        <Link 
          to="#"
          onClick={handleClick}
          className="h-10 rounded-md bg-indigo-500 text-sm font-medium text-white flex items-center justify-center hover:bg-white transition-colors"
        >
  ...
  return (
    <>
      <Link 
        to="#"
        className="h-8 px-4 rounded-md bg-indigo-500 hover:bg-indigo-600 text-sm font-medium text-white flex items-center transition-colors"
      >
        Entrar com o Discord
      </Link>
    </>
