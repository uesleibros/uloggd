		...
		<div className="space-y-4">
			...
			>
				{preview ? (
					...
					<div className="w-full aspect-[16/4] flex items-center justify-center p-4">
				...
				{preview && (
					<div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 flex items-center justify-center gap-2 sm:gap-3 transition-all duration-200 p-4">
						<div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
							<button
								onClick={(e) => { e.stopPropagation(); setMode("choose") }}
								className="w-full sm:w-auto px-4 py-2 text-xs sm:text-sm font-medium text-white bg-zinc-800/90 hover:bg-zinc-700 border border-zinc-600 rounded-lg transition-colors cursor-pointer backdrop-blur-sm"
							>
								Alterar
							</button>
							<button
								onClick={(e) => { e.stopPropagation(); handleRemove() }}
								className="w-full sm:w-auto px-4 py-2 text-xs sm:text-sm font-medium text-red-400 bg-zinc-800/90 hover:bg-red-500/20 border border-zinc-600 hover:border-red-500/50 rounded-lg transition-colors cursor-pointer backdrop-blur-sm"
							>
								Remover
							</button>
						</div>
