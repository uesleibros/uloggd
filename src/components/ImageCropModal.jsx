		...
		<div className="space-y-4">
			<div className="rounded-lg overflow-hidden border border-zinc-700 bg-zinc-800/50">
				{preview ? (
					<>
						...
						<div className="flex border-t border-zinc-700">
							<button
								...
								className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-zinc-300 hover:text-white hover:bg-zinc-700/50 active:bg-zinc-700/50 transition-colors cursor-pointer border-r border-zinc-700"
							>
							...
							<button
								...
								className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 active:bg-red-500/10 transition-colors cursor-pointer"
							>
								<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<div
						className="w-full aspect-[16/4] flex items-center justify-center p-4 cursor-pointer hover:bg-zinc-800/80 active:bg-zinc-800/80 transition-colors"
						onClick={() => setMode("choose")}
					>
