export function TwitchIcon({ className }) {
	return (
...
export function PlayStationIcon({ className }) {
  return (
    <svg 
      viewBox="0 0 24 24" 
      fill="currentColor" 
      className={className}
    >
      <path d="M9.5 2v18.5l3.5 1.1V7.2c0-.5.2-.8.5-.7.4.1.5.5.5 1v4.3c1.8.9 3.2 0 3.2-2.3 0-2.4-.8-3.4-3.2-4.3-1-.3-2.7-.9-4-.5zM15 15.5c-1.3.5-2.7.8-4 1v2.1c1.3-.2 2.7-.5 4-1 1.6-.6 2.2-1.4 2.2-2.6 0-1.2-.6-1.6-2.2-.9zM3 16.3c-1.1.3-.7 1.1.6 1.4 1.4.4 2.9.5 4 .2v-2.1c-1.1.3-2.6.2-4-.2-.6-.2-.9-.4-.6-.6.4-.2 1.1-.1 1.7.2l2.1.7v-2.1l-.4-.1c-1.1-.4-2.2-.5-3.4-.3z"/>
    </svg>
  )
}
