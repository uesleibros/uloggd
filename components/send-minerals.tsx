...
import { LoaderCircle, Minus, Plus, Send, X } from "lucide-react";
    ...
    >
      ...
      <Dialog.Portal>
        ...
        >
          ...
          {sent ? (
            <p className="send-minerals-done" role="status">
              {tri(
                lang,
                ...
                {spendable.map((holding) => {
                  ...
                  return (
                    <li key={holding.mineral}>
                      ...
                      />
                      <span>
                        <strong>{MINERAL_NAMES[holding.mineral](lang)}</strong>
                        <small>
                          {tri(
                            lang,
